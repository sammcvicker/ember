"""File content data for the realistic_repo fixture.

This module contains the file contents used by the realistic_repo fixture.
Moving this data out of conftest.py keeps that file manageable in size.
"""

from pathlib import Path

# File contents for the realistic repository fixture
# Each tuple is (relative_path, content)
REALISTIC_REPO_FILES: list[tuple[str, str]] = [
...
def create_realistic_repo(repo_path: Path) -> None:
    """Create the realistic repository file structure and content.

    This function creates all directories and files for the realistic_repo fixture.
    It should be called after git init has been done on repo_path.
    ...
    # Write all files
    for relative_path, content in REALISTIC_REPO_FILES:
